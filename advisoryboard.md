...
<h1>WiCS+E Advisory Board</h1>

<p>
  The strength of WiCS+E lies in the experience, insight, and support of our Advisory Board (listed in alphabetical order).
</p>
...
<img
        src="{{ '/advisory-board-images/StephanLewandowsky.jpg' | relative_url }}"
        alt="Stephan Lewandowsky"
        class="leader-card-photo"
        loading="lazy">
...
<img
  ...
  <div class="leader-card">
    <a class="leader-link"
       ...
       target="_blank"
       rel="noopener noreferrer"
       aria-label="Visit personal page of Anna Soveri">
<img
        src="{{ '/advisory-board-images/AnnaSoveri.jpg' | relative_url }}"
        alt="Anna Soveri"
        class="leader-card-photo"
        loading="lazy">
